...
deploy:
	...
	gcloud functions deploy www-surrealdb-com --project surreal-io --region europe-west2 --runtime nodejs10 --entry-point main --trigger-http --security-level secure-always --memory 2048MB --timeout 10s
