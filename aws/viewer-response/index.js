function handler(event) {
    ...
    headers['content-security-policy'] = { value: "base-uri 'self'; block-all-mixed-content; connect-src 'self' wss://surreal.io/rpc https://contact.abcum.com https://www.google-analytics.com/ https://api.mixpanel.com; default-src 'none'; font-src 'self'; form-action 'none'; frame-ancestors 'self'; img-src 'self' https://cdn.brandsafe.io/ https://www.google-analytics.com/ https://www.linkedin.com/px/ https://px.ads.linkedin.com/; manifest-src 'self'; media-src 'self'; script-src 'self' https://www.google-analytics.com/ https://cdn.mxpnl.com/; style-src 'self'; upgrade-insecure-requests; worker-src 'self'" };
